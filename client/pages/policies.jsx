...
function Policies({ data }) {
    ...
    return (
        ...
        <div className='flex 2xl:flex-row  xl:flex-row  lg:flex-row md:flex-col sm:flex-col flex-col '>
            <head>
                <title>TuitionApp - Policies</title>
            </head>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg">
                    <div className="container px-12 py-16 mx-auto">
                        <div className="mb-8 md:mb-12">
                            <h2 className="text-gray-800 dark:text-gray-200 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">Privacy policies</h2>
